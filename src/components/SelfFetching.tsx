...
function FetcherWrapper({
  ...
  if (isLoading)
    return <>{loadingFallback ?? <LoadingSkeleton name={name} />}</>;
  if (error || !data)
    return (
      <>
        {errorFallback ?? (
          <ErrorState name={name} message={error?.message ?? "Not found"} />
        )}
      </>
    );
  return <>{children}</>;
...
function CollectionFetcher({
  collectionId,
  ...rest
}: Omit<CollectionSelfFetchProps, "data"> & { collectionId: string | number }) {
  const { data, isLoading, error } = useCollectionData(collectionId);
  return (
    <FetcherWrapper
      name="Collection"
      isLoading={isLoading}
      error={error}
      data={data}
      loadingFallback={rest.loadingFallback}
...
export function Collection(props: CollectionSelfFetchProps) {
  const collectionId = props.collectionId ?? props.id;
  if (props.data) {
    return (
      <CollectionComponent
        data={props.data}
  ...
  return (
    <ErrorState name="Collection" message="Either data or id is required" />
  );
}
...
function PollFetcher({
  appId,
  ...rest
}: Omit<PollSelfFetchProps, "data"> & { appId: number }) {
  ...
  return (
    ...
    >
      {data && (
        <PollComponent
          data={data}
          showVoteButton={rest.showVoteButton}
          compact={rest.compact}
          size={rest.size}
          className={rest.className}
          onVote={rest.onVote}
...
export function Poll(props: PollSelfFetchProps) {
  if (props.data)
    return (
      <PollComponent
        data={props.data}
        showVoteButton={props.showVoteButton}
        compact={props.compact}
        size={props.size}
        className={props.className}
        onVote={props.onVote}
...
function RaffleListingFetcher({
  appId,
  ...rest
}: Omit<RaffleListingSelfFetchProps, "data"> & { appId: number }) {
  ...
  return (
    ...
    >
      {data && (
        <RaffleListingComponent
          data={data}
          showEntryButton={rest.showEntryButton}
          size={rest.size}
          className={rest.className}
          imageUrl={rest.imageUrl}
...
export function RaffleListing(props: RaffleListingSelfFetchProps) {
  if (props.data)
    return (
      <RaffleListingComponent
        data={props.data}
        showEntryButton={props.showEntryButton}
        size={props.size}
        className={props.className}
        imageUrl={props.imageUrl}
  ...
  return (
    <ErrorState name="Raffle" message="Either data or appId is required" />
  );
}
...
function AuctionListingFetcher({
  appId,
  ...rest
}: Omit<AuctionListingSelfFetchProps, "data"> & { appId: number }) {
    ...
    >
      {data && (
        <AuctionListingComponent
          data={data}
          showBidButton={rest.showBidButton}
          size={rest.size}
          className={rest.className}
          imageUrl={rest.imageUrl}
          onBid={rest.onBid}
...
export function AuctionListing(props: AuctionListingSelfFetchProps) {
  if (props.data)
    return (
      <AuctionListingComponent
        data={props.data}
        showBidButton={props.showBidButton}
        size={props.size}
        className={props.className}
        imageUrl={props.imageUrl}
        onBid={props.onBid}
  ...
  return (
    <ErrorState name="Auction" message="Either data or appId is required" />
  );
}
...
function NFTListingFetcher({
  appId,
  ...rest
}: Omit<NFTListingSelfFetchProps, "data"> & { appId: number }) {
  ...
  return (
    ...
    >
      {data && (
        <NFTListingComponent
          data={data}
          showPurchaseButton={rest.showPurchaseButton}
          size={rest.size}
          className={rest.className}
          imageUrl={rest.imageUrl}
          onPurchase={rest.onPurchase}
          onFavorite={rest.onFavorite}
        />
      )}
    </FetcherWrapper>
  );
...
export function NFTListing(props: NFTListingSelfFetchProps) {
  if (props.data)
    return (
      <NFTListingComponent
        data={props.data}
        showPurchaseButton={props.showPurchaseButton}
        size={props.size}
        className={props.className}
        imageUrl={props.imageUrl}
  ...
  return (
    <ErrorState name="NFT Listing" message="Either data or appId is required" />
  );
}
...
function TradeOfferFetcher({
  appId,
  offerId,
  ...rest
}: Omit<TradeOfferSelfFetchProps, "data"> & {
  appId: number;
  offerId: number;
}) {
  ...
  return (
    ...
    >
      {data && (
        <TradeOfferComponent
          data={data}
          showActions={rest.showActions}
          size={rest.size}
          className={rest.className}
          currentUserAddress={rest.currentUserAddress}
          onAccept={rest.onAccept}
...
export function TradeOffer(props: TradeOfferSelfFetchProps) {
  ...
  return (
    <ErrorState
      name="Trade Offer"
      message="Either data or (appId + offerId) is required"
    />
  );
}
...
function AccountFetcher({
  address,
  ...rest
}: Omit<AccountSelfFetchProps, "data"> & { address: string }) {
  ...
  return (
    ...
    >
      {data && (
        <AccountDisplay
          data={data}
          showAssets={rest.showAssets}
          showApps={rest.showApps}
          compact={rest.compact}
          size={rest.size}
          className={rest.className}
          onExternalLink={rest.onExternalLink}
        />
      )}
    </FetcherWrapper>
  );
...
export function Account(props: AccountSelfFetchProps) {
  ...
  return (
    <ErrorState name="Account" message="Either data or address is required" />
  );
}
...
function ASAFetcher({
  assetId,
  ...rest
}: Omit<ASASelfFetchProps, "data"> & { assetId: number }) {
...
function TransactionDetailsFetcher({
  txId,
  ...rest
}: Omit<TransactionDetailsSelfFetchProps, "data"> & { txId: string }) {
...
export function TransactionDetails(props: TransactionDetailsSelfFetchProps) {
  ...
  return (
    <ErrorState name="Transaction" message="Either data or txId is required" />
  );
}
...
function NFDProfileFetcher({
  name,
  ...rest
}: Omit<NFDProfileSelfFetchProps, "data"> & { name: string }) {
  ...
  return (
    ...
    >
      {data && (
        <NFDProfileComponent
          data={data}
          showBio={rest.showBio}
          showProperties={rest.showProperties}
          compact={rest.compact}
          size={rest.size}
          className={rest.className}
        />
...
export function NFDProfile(props: NFDProfileSelfFetchProps) {
  ...
  return (
    <ErrorState name="NFD Profile" message="Either data or name is required" />
  );
}
